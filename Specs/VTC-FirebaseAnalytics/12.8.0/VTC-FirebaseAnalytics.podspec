Pod::Spec.new do |s|
    s.name             = 'VTC-FirebaseAnalytics'
    s.module_name       = 'FirebaseAnalytics'
    s.version          = '12.8.0'
    ...
    s.source           = {
        :http => 'https://dl.google.com/firebase/ios/analytics/3b57be475bd21097/FirebaseAnalytics-12.8.0.tar.gz'
    }
    ...
    s.dependency 'VTC-FirebaseCore', '~> 12.8.0'
    s.dependency 'VTC-FirebaseInstallations', '~> 12.8.0'
